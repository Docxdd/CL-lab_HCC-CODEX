...
wide_data <- reshape2::dcast(merged_data, Class + LiverCirrhosis ~ celltype, value.var = "celltype", fun.aggregate = length)

wide_data<-wide_data[c(1,2,3,4,6,7,11,12)] #选择免疫细胞
